 ...
 * @param {string} formTag - Main form tag (e.g., "HSE_TGNRSTMISCENT")
...
export function manageObservationTabs(formTag, tabsEnabled, TabEnable) {
  ...
  const investigationTeamTab = 'HSE_TgNrstMiscEntinvstgtntems';
  const commentsTab = 'HSE_TGNERMSENTCMNTS';
