...
export async function toolBarButtonClicked(eventObj, callBackFn) {
  ...
  try {
    ...
    console.warn('[Web_HSE] Observation Targets toolBarButtonClicked tab management:', error);
  }
...
export async function ShowScreen(setScreenDisableBtn, strScrTag, strTabTag, devInterfaceObj) {
  ...
  try {
    ...
    console.warn('[Web_HSE] Observation Targets ShowScreen: error mapping unknown field types:', error);
  }
  ...
  if (!strTabTag || strTabTag === '') {
    try {
      ...
      console.warn('[Web_HSE] Observation Targets ShowScreen: error enabling observation tabs:', error);
    }
  }
}
