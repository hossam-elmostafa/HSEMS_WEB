...
HRESULT AccidentCategory::DisplayRecordRepostion(RECORDREPOSTION *pRecordRepostion)
{
	...
	if(pRecordRepostion->iComplete==1)
	{
		...
		/*If (require investigation = Yes) then hide/lock the following TABS 
			(environment conditions, 
			 ...
			 investigation team, 
			 comments) 
		 ELSE enable all these TAB's.*/
		if(strFormTag == "HSE_TGACDNTENT") {
			CString strRqrInvstgtn = FormGetField("HSE_ACDNTENT","ACDNTENT_RQRINVSTGTN");
			if(strRqrInvstgtn == "Y") {
				EnableTab("HSE_TGACDNTENTENVRNMNTCNDTNS",false);
				EnableTab("HSE_TGACDNTENTPOLCRPRT",false);
				EnableTab("HSE_TGACDNTENTQSTNS",false);
				EnableTab("HSE_TGACDNTENTWTNSS",false);
				EnableTab("HSE_TGACDNTENTINFRMPRTY",false);
				EnableTab("HSE_TGACDNTENTLRNDLSON",false);
				EnableTab("HSE_TGACDNTENTRFRNCS",false);
				EnableTab("HSE_TGACDNTENTINVSTGTNTEMS",false);
				EnableTab("HSE_TGACCDNTENTCMNTS",false);					
			} else {
				EnableTab("HSE_TGACDNTENTENVRNMNTCNDTNS",true);
				EnableTab("HSE_TGACDNTENTPOLCRPRT",true);
				EnableTab("HSE_TGACDNTENTQSTNS",true);
				EnableTab("HSE_TGACDNTENTWTNSS",true);
				EnableTab("HSE_TGACDNTENTINFRMPRTY",true);
				EnableTab("HSE_TGACDNTENTLRNDLSON",true);
				EnableTab("HSE_TGACDNTENTRFRNCS",true);
				EnableTab("HSE_TGACDNTENTINVSTGTNTEMS",true);
				EnableTab("HSE_TGACCDNTENTCMNTS",true);
			}				
		}
...
HRESULT AccidentCategory::DisplayCustomButtonClicked(tag_CustomButtonClicked* pCustomButtonClicked)
{
	...
	CString strSubForm_Tag=pCustomButtonClicked->SubForm_Tag;
	///////////////////////////////////////////////////////////////////////////////////////////////////
	//Bugs-10-2021.58
	if(strSubForm_Tag=="HSE_TGACDNTCNFRMTNINJRDPRSN")
	{
...
//Moved to HSEMSCommonCategory as it will be also called from Incident Medical screens 
